...
background-color:#B0E0E6;
  ...
  <div id="container" style="width:100%;height:100%">
    ...
    <div id="header">学生宿舍管理系统</div>
<div class="left">
    <ul>
<li><a href="#home"  target="iframe_a">首页</a></li>
<li><a href="#news"  target="iframe_a">学生调宿舍</a></li>
<li><a href="#contact"  target="iframe_a">宿舍楼查询</a></li>
<li><a href="#news"  target="iframe_a">学生信息查询</a></li>
<li><a href="addstu.jsp"  target="iframe_a">录入学生信息</a></li>

<li><a href="#about">宿管员信息查询</a></li>
