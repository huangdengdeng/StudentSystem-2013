...
<div class="left">
    <ul>
<li><a href="employee.jsp"  >首页</a></li>
<li><a href="FindStuCount"  target="iframe_a">查询空宿舍</a></li>
<li><a href="addstu.jsp"  target="iframe_a">录入学生信息</a></li>
<li><a href="FindStuServlet"  target="iframe_a">管理学生信息</a></li>
<li><a href="addrecord.jsp"  target="iframe_a">录入学生晚归</a></li>
<li><a href="FindRecordServlet"  target="iframe_a">管理晚归信息</a></li>
  </ul>
